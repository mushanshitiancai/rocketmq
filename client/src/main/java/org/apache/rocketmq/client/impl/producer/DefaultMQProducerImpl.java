...
public class DefaultMQProducerImpl implements MQProducerInner {
    ...
    /**
     * 三种发送方式（同步，异步，oneway）最终都会走到这里
     *
     * @param msg               消息对象
     * @param communicationMode 同步发布时是CommunicationMode.SYNC
     *                          异步发送时是CommunicationMode.ASYNC
     *                          Oneway发送时是CommunicationMode.ONEWAY
     * @param sendCallback      异步发送时是回调对象，否则是null
    ...
    private SendResult sendDefaultImpl(
        ...
        // 走到这里说明没有开启自动创建topic，并且找不到topic的路由信息，这里看一下是不是因为没有NameServer导致的
        ...
        // 走到这里说明没有开启自动创建topic，并且找不到topic的路由信息
    ...
    private SendResult sendKernelImpl(final Message msg,
        ...
        if (brokerAddr != null) {
            // 如果客户端配置了vipChannelEnabled == true，则使用VIP端口
                ...
                switch (communicationMode) {
                    ...
                    case SYNC: // 同步发送场景
                        ...
                        sendResult = this.mQClientFactory.getMQClientAPIImpl().sendMessage(
                            ...
                            msg,
                            requestHeader,
                            timeout - costTimeSync, // 更新超时时间为剩余的超时时间
                            communicationMode,
                            context,
                            this);
                        break;
